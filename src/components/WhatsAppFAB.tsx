...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl transition-transform hover:scale-110 duration-200"
    >

...
export default function ResenasGoogle() {
  ...
  const progress = ((current + 1) / reviews.length) * 100;
    ...
    <div className="mt-16 border-t border-gray-100 pt-12">
      ...
      <div className="flex items-center gap-4 mt-6">
        <button
          ...
          className="w-9 h-9 border border-gray-200 hover:border-navy-800 hover:bg-navy-800 hover:text-white text-navy-800 flex items-center justify-center transition-colors shrink-0"
          aria-label="Anterior"
        >
          ‹
        </button>

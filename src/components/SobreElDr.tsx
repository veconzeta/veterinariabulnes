  ...
  return (
    <section id="doctor" className="bg-white py-24">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Fila superior: descripción + credenciales */}
        <div className="grid md:grid-cols-[1fr_320px] gap-20 items-start mb-16">
        ...
        {/* Historia — ancho completo, debajo del grid */}
        <div className="border-t border-gray-100 pt-12">
          <p className="section-label mb-10">Historia</p>

          <div className="grid md:grid-cols-[260px_1fr] gap-12 md:gap-20 items-start">

            {/* Izquierda: año + título + controles */}
            <div>
              <p className="text-xs font-bold text-navy-500 tracking-widest mb-3">
                {slides[current].año}
              </p>
              <h3 className="text-2xl font-bold text-navy-900 leading-snug mb-10">
